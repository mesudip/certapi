...
from src.certapi.challenge import ChallengeStore
from src.certapi.cloudflare_client import Cloudflare
...
class CloudflareChallengeStore(ChallengeStore):
    ...
    def save_challenge(self, key: str, value: str):
        ...
        base_domain = self.cloudflare.determine_registered_domain(key)
